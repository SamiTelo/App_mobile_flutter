...
import 'package:mini_ecommerce/screens/category/category_screen.dart';
...
import '../widgets/appbar/category_app_bar.dart';
...
final List<ScreenData> screensData = const [
  ScreenData(screen: CategoryScreen(), appBar: CategoryAppBar()), // index 0 → Grid
